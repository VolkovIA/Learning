...
//void Chat::send(const string& name, const bool& check)
//{
//	if (name != "ALL"&& check)
//	{
//		for (int i = 0; i < size_; i++)
//		{
//			if (userData_[i].getLogin() == name)
//			{
//				cout << "Введите сообщение: ";
//				cin.ignore();
//				getline(cin, outg_message_);
...
//string Chat::getName(int i)
//{
//	return userData_[i].getName();
//}
//
//string Chat::getLogin(int i)
//{
//	return userData_[i].getLogin();
//}